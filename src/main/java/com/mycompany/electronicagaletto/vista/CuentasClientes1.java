...
public class CuentasClientes1 extends javax.swing.JPanel {
    ...
    public CuentasClientes1( Usuario usr) {
    ...
    private void btnPagoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPagoActionPerformed
        ShowJPanel1(new PagoCuentaCliente1(usr, cliente,sald));
    ...
    private void btnGenePDFActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGenePDFActionPerformed
        ...
        String fecha = f.format(fechaActual);
            ...
            try{
                ...
                PdfWriter.getInstance(documento, new FileOutputStream(ruta+"/Desktop/Reportes/CuentaCliente_1.pdf"));
