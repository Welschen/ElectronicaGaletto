...
public class EditGrupo extends javax.swing.JPanel {
    ControladoraLogica control = null;
    int id; 
    Grupo grup;
    Usuario usr;
    public EditGrupo(int id, Usuario usr) {
    ...
    private void btnNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNuevoActionPerformed
        ...
        control.editarGrupo(grup,bene, bstock,txtNomGrupo.getText());
    ...
    private void cargarDatos(int id) {
        this.grup = control.traerGrupo(id);
        
        txtBajoStock.setText(String.valueOf(grup.getBajoStock()));
        txtBene.setText(String.valueOf(grup.getBeneficio()));
        txtNomGrupo.setText(grup.getNombreGrupo());
